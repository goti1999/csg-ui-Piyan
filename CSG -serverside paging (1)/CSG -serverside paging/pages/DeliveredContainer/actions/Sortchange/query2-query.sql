...
DECLARE @SortColumn NVARCHAR(100) = '{{ui.ontable13.sort[0]?.column ?? "TransmissionTimestamp"}}';
DECLARE @SortDirection NVARCHAR(4) = UPPER('{{ui.ontable13.sort[0]?.direction ?? "DESC"}}');
