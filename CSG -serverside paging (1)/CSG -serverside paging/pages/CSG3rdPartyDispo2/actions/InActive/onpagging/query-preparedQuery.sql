...
DECLARE @PortOfDischarge_Lima NVARCHAR(255) = '?';
DECLARE @ETA_PortOfDischarge NVARCHAR(255) = '?';
DECLARE @PackingMethod NVARCHAR(255) = '?';
DECLARE @TotalWeight NVARCHAR(255) = '?';
DECLARE @AdvertFlag NVARCHAR(255) = '?';
DECLARE @RealAdvertFlag NVARCHAR(255) = '?';
DECLARE @EarliestAdvertDate NVARCHAR(255) = '?';
DECLARE @EarliestRealAdvertDate NVARCHAR(255) = '?';
DECLARE @todo NVARCHAR(255) = '?';
DECLARE @last_eventID NVARCHAR(255) = '?';
DECLARE @PortOfLoading_Lima NVARCHAR(255) = '?';
DECLARE @ETD_PortOfLoading NVARCHAR(255) = '?';
DECLARE @Terminal_Inland_Vorgabe_NTL NVARCHAR(255) = '?';
DECLARE @ETA_Terminal_Inland NVARCHAR(255) = '?';
DECLARE @DeliveryAddress NVARCHAR(255) = '?';
DECLARE @ETA_DeliveryAddress NVARCHAR(255) = '?';
DECLARE @Transport_Mode_Terminal NVARCHAR(255) = '?';
DECLARE @Transport_Mode_final_DeliveryAddress NVARCHAR(255) = '?';
DECLARE @ATA_DeliveryAddress NVARCHAR(255) = '?';
DECLARE @transport_Dispo_ID NVARCHAR(255) = '?';
DECLARE @Condition NVARCHAR(255) = '?';
DECLARE @into_CW1 NVARCHAR(255) = '?';
DECLARE @to_Customer NVARCHAR(255) = '?';
DECLARE @to_Transporter NVARCHAR(255) = '?';
DECLARE @DropOff_Terminal NVARCHAR(255) = '?';
DECLARE @Terminal_PortOfDischarge NVARCHAR(255) = '?';
DECLARE @Pincode NVARCHAR(255) = '?';
DECLARE @DropOff_Terminal_TIR NVARCHAR(255) = '?';
DECLARE @Delivered NVARCHAR(255) = '?';
DECLARE @Remarks NVARCHAR(255) = '?';
DECLARE @HouseBill NVARCHAR(255) = '?';
DECLARE @Containerverfuegbarkeit NVARCHAR(255) = '?';
DECLARE @ETA_Service_Provider NVARCHAR(255) = '?';
DECLARE @ATA_Terminal_Inland NVARCHAR(255) = '?';
DECLARE @ATD_Terminal_Inland NVARCHAR(255) = '?';
DECLARE @Return_Date_to_Depot NVARCHAR(255) = '?';
DECLARE @ATD_Seaport NVARCHAR(255) = '?';
DECLARE @ETD_Seaport NVARCHAR(255) = '?';
DECLARE @ETA_Seaport NVARCHAR(255) = '?';
DECLARE @ATA_Seaport NVARCHAR(255) = '?';
DECLARE @final_date_delivery_address NVARCHAR(255) = '?';
DECLARE @ctv_booking_id NVARCHAR(255) = '?';
DECLARE @CTV_ETA_PortOfDischarge NVARCHAR(255) = '?';
DECLARE @PortOfDischarge_UNLOCO NVARCHAR(255) = '?';
DECLARE @PortOfLoading_UNLOCO NVARCHAR(255) = '?';
DECLARE @ATA_DropOff_Terminal NVARCHAR(255) = '?';
DECLARE @DeliveryAddress_CTV NVARCHAR(255) = '?';
DECLARE @PortOfDischarge_UNLOCO_CTV NVARCHAR(255) = '?';
DECLARE @Transport_Mode_Terminal_CTV NVARCHAR(255) = '?';
DECLARE @Carrier_CTV NVARCHAR(255) = '?';
DECLARE @customs_document_number NVARCHAR(255) = '?';
DECLARE @customs_document_type NVARCHAR(255) = '?';
DECLARE @Terminal_Inland_CTV NVARCHAR(255) = '?';
DECLARE @ETD_Pickup_PortOfDischarge NVARCHAR(255) = '?';
DECLARE @ATD_Pickup_PortOfDischarge NVARCHAR(255) = '?';
DECLARE @pinRequested NVARCHAR(255) = '?';
DECLARE @pinState NVARCHAR(255) = '?';
DECLARE @nationalTransportState NVARCHAR(255) = '?';
DECLARE @finalDeliveryState NVARCHAR(255) = '?';
DECLARE @emptyReturnState NVARCHAR(255) = '?';
DECLARE @ETA_Terminal_Inland_Vorgabe_NTL NVARCHAR(255) = '?';
DECLARE @DeliveryInfo_send_to_CTV NVARCHAR(255) = '?';
DECLARE @new NVARCHAR(255) = '?';
DECLARE @Transport_Mode_Terminal_Vorgabe_NTL NVARCHAR(255) = '?';
DECLARE @Terminal_Inland_CundA NVARCHAR(255) = '?';
DECLARE @Direct_Truck NVARCHAR(255) = '?';
DECLARE @eventType NVARCHAR(255) = '?';
DECLARE @Transport_To_Terminal NVARCHAR(255) = '?';
DECLARE @Transport_Document_Number NVARCHAR(255) = '?';
DECLARE @Seal_Number NVARCHAR(255) = '?';
DECLARE @ETA_DeliveryAddress_CTV NVARCHAR(255) = '?';
DECLARE @Cancelation_Send_To_CTV NVARCHAR(255) = '?';
DECLARE @TAC NVARCHAR(255) = '?';
DECLARE @ETA_Delivery_Address_Update_TimeStamp NVARCHAR(255) = '?';
