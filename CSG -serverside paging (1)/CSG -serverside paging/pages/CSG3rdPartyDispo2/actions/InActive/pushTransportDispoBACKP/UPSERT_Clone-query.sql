...
BEGIN
    ...
    BEGIN
        ...
        SET
            ...
            ETA_DeliveryAddress = {{ ui.form4.value.ETA_DeliveryAddress ? moment(ui.form4.value.ETA_DeliveryAddress).toISOString() : null }},
            Remarks = {{ ui.form4.value.Remarks ?? '' }},
            DeliveryAddress = {{ ui.form4.value.DeliveryAddress ?? '' }},
            ATA_Terminal_Inland = {{ ui.form4.value.ATA_Terminal_Inland ? moment(ui.form4.value.ATA_Terminal_Inland).toISOString() : null }},
            Containerverfuegbarkeit = {{ ui.form4.value.Containerverfuegbarkeit ? moment(ui.form4.value.Containerverfuegbarkeit).toISOString() : null }},
    ...
    BEGIN
        ...
        VALUES (
            ...
            {{ ui.form4.value.ETA_DeliveryAddress ? moment(ui.form4.value.ETA_DeliveryAddress).toISOString() : null }},
            {{ ui.form4.value.Remarks ?? '' }},
            {{ ui.form4.value.DeliveryAddress ?? '' }},
            {{ ui.form4.value.ATA_Terminal_Inland ? moment(ui.form4.value.ATA_Terminal_Inland).toISOString() : null }},
            {{ ui.form4.value.Containerverfuegbarkeit ? moment(ui.form4.value.Containerverfuegbarkeit).toISOString() : null }},
