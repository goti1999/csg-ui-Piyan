...
VALUES (
    {{ ui.form9.value.CustomerID ?? 'UNKNOWN' }},
    {{ ui.form9.value.MBL_ID ?? 0 }},
    {{ ui.form9.value.ContainerID ?? 0 }},
    {{ ui.form9.value.MBL_No ?? 'UNKNOWN' }},
    {{ ui.form9.value.Container_No ?? 'UNKNOWN' }},
    {{ ui.form9.value.Status_Dispo ?? 'transport' }},
    ...
    {{ ui.form9.value.ContainerSize ?? null }},
    {{ ui.form9.value.Carrier ?? null }},
    {{ ui.form9.value.Vessel ?? null }},
    ...
    {{ ui.form9.value.to_Transporter ?? 0 }},
    {{ moment().utcOffset(0, true).toISOString() }},
    'Transport_Clone'
);
