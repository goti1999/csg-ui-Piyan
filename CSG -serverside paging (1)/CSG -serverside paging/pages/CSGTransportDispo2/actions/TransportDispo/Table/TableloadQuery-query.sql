...
WHERE
  ...
  AND (
    ...
    OR d.Status_Transport = {{ ui.ontable4.filters.Status_Transport }} 
    OR (
  ...
  AND (
    ...
    OR d.ContainerSize = {{ ui.ontable4.filters.ContainerSize }} 
    OR (
  ...
  AND (
    ...
    OR d.Condition = {{ ui.ontable4.filters.Condition }} 
    OR (
  ...
  OR d.Status_Dispo = {{ ui.ontable4.filters.Status_Dispo }}
  OR (
