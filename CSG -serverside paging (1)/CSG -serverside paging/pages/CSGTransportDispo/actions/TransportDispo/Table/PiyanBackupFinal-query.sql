...
WHERE
  ...
  AND (
    ...
    OR d.Status_Transport LIKE '%' + {{ ui.ontable10.filters.Status_Transport }} + '%'
    OR (
      {{ ui.ontable10.filters.Status_Transport }} = 'empty'
      AND (d.Status_Transport IS NULL OR d.Status_Transport = '')
    )
  )
  AND (
    {{ ui.ontable10.filters.MBL_No ?? "" }} = ''
    OR tm.Wert LIKE '%' + {{ ui.ontable10.filters.MBL_No }} + '%'
    OR (
      {{ ui.ontable10.filters.MBL_No }} = 'empty'
      AND (tm.Wert IS NULL OR tm.Wert = '')
    )
  )
  AND (
    {{ ui.ontable10.filters.Container_No ?? "" }} = ''
    OR tm2.Wert LIKE '%' + {{ ui.ontable10.filters.Container_No }} + '%'
    OR (
      {{ ui.ontable10.filters.Container_No }} = 'empty'
      AND (tm2.Wert IS NULL OR tm2.Wert = '')
    )
  )
  AND (
    {{ ui.ontable10.filters.Carrier ?? "" }} = ''
    OR d.Carrier LIKE '%' + {{ ui.ontable10.filters.Carrier }} + '%'
    OR (
      {{ ui.ontable10.filters.Carrier }} = 'empty'
      AND (d.Carrier IS NULL OR d.Carrier = '')
    )
  )
  AND (
    {{ ui.ontable10.filters.Vessel ?? "" }} = ''
    OR d.Vessel LIKE '%' + {{ ui.ontable10.filters.Vessel }} + '%'
    OR (
      {{ ui.ontable10.filters.Vessel }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.ContainerSize }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.Broker }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.Voyage }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.PackingMethod }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.TotalWeight }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.Transport_Mode_final_DeliveryAddress }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.Transport_Mode_Terminal }} = 'empty'
      AND (d.Transport_Mode_Terminal IS NULL OR d.Transport_Mode_Terminal = '')
    )
  )
  AND (
    {{ ui.ontable10.filters.Terminal_Inland_CundA ?? "" }} = ''
    OR d.Terminal_Inland_CundA LIKE '%' + {{ ui.ontable10.filters.Terminal_Inland_CundA }} + '%'
    OR (
      {{ ui.ontable10.filters.Terminal_Inland_CundA }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.Terminal_Inland_CTV }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.DropOff_Terminal }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.Terminal_Inland_Vorgabe_NTL }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.DropOff_Terminal_TIR }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.Pincode }} = 'empty'
      AND (d.Pincode IS NULL OR d.Pincode = '')
    )
  )
  AND (
    {{ ui.ontable10.filters.Condition ?? "" }} = ''
    OR d.Condition LIKE '%' + {{ ui.ontable10.filters.Condition }} + '%'
    OR (
      {{ ui.ontable10.filters.Condition }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.Terminal_PortOfDischarge }} = 'empty'
      AND (d.Terminal_PortOfDischarge IS NULL OR d.Terminal_PortOfDischarge = '')
    )
  )
  AND (
    {{ ui.ontable10.filters.Status_Dispo ?? "" }} = ''
    OR d.Status_Dispo LIKE '%' + {{ ui.ontable10.filters.Status_Dispo }} + '%'
    OR (
      {{ ui.ontable10.filters.Status_Dispo }} = 'empty'
      AND (d.Status_Dispo IS NULL OR d.Status_Dispo = '')
    )
  )
  AND (
    {{ ui.ontable10.filters.CustomerID ?? "" }} = ''
    OR d.CustomerID LIKE '%' + {{ ui.ontable10.filters.CustomerID }} + '%'
    OR (
      {{ ui.ontable10.filters.CustomerID }} = 'empty'
      AND (d.CustomerID IS NULL OR d.CustomerID = '')
    )
  )
  AND (
    {{ ui.ontable10.filters.MBL_ID ?? "" }} = ''
    OR d.MBL_ID LIKE '%' + {{ ui.ontable10.filters.MBL_ID }} + '%'
    OR (
      {{ ui.ontable10.filters.MBL_ID }} = 'empty'
      AND (d.MBL_ID IS NULL OR d.MBL_ID = '')
    )
  )
  AND (
    {{ ui.ontable10.filters.transport_Dispo_ID ?? "" }} = ''
    OR d.transport_Dispo_ID LIKE '%' + {{ ui.ontable10.filters.transport_Dispo_ID }} + '%'
    OR (
      {{ ui.ontable10.filters.transport_Dispo_ID }} = 'empty'
      AND (d.transport_Dispo_ID IS NULL OR d.transport_Dispo_ID = '')
    )
  )
  AND (
    {{ ui.ontable10.filters.ContainerID ?? "" }} = ''
    OR d.ContainerID LIKE '%' + {{ ui.ontable10.filters.ContainerID }} + '%'
    OR (
      {{ ui.ontable10.filters.ContainerID }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.PortOfDischarge_UNLOCO }} = 'empty'
  ...
  AND (
    ...
    OR (
      {{ ui.ontable10.filters.DeliveryAddress }} = 'empty'
 ...
 --bit
   ...
   AND (
    {{ ui.ontable10.filters.AdvertFlag }} IS NULL
    OR d.AdvertFlag = {{ ui.ontable10.filters.AdvertFlag }}
  )
  AND (
    {{ ui.ontable10.filters.RealAdvertFlag }} IS NULL
    OR d.RealAdvertFlag = {{ ui.ontable10.filters.RealAdvertFlag }}
  )
  AND (
    {{ ui.ontable10.filters.Direct_Truck }} IS NULL
    OR d.Direct_Truck = {{ ui.ontable10.filters.Direct_Truck }}
  )
  AND (
    {{ ui.ontable10.filters.to_Customer }} IS NULL
    OR d.to_Customer = {{ ui.ontable10.filters.to_Customer }}
  )
  AND (
    {{ ui.ontable10.filters.to_Transporter }} IS NULL
  ...
  OR (
    {{ ui.ontable10.filters.EarliestAdvertDate }} = 'empty'
...
AND (
  ...
  OR (
    {{ ui.ontable10.filters.ETA_PortOfDischarge }} = 'empty'
...
AND (
  ...
  OR (
    {{ ui.ontable10.filters.ETA_Terminal_Inland }} = 'empty'
...
AND (
  ...
  OR (
    {{ ui.ontable10.filters.ATA_Terminal_Inland }} = 'empty'
...
AND (
  ...
  OR (
    {{ ui.ontable10.filters.ETA_DeliveryAddress }} = 'empty'
...
AND (
  ...
  OR (
    {{ ui.ontable10.filters.ATA_DeliveryAddress }} = 'empty'
...
AND (
  ...
  OR (
    {{ ui.ontable10.filters.FirstTimestamp }} = 'empty'
...
AND (
  ...
  OR (
    {{ ui.ontable10.filters.ATA_DropOff_Terminal }} = 'empty'
...
AND (
  ...
  OR (
    {{ ui.ontable10.filters.TransmissionTimestamp }} = 'empty'
...
AND (
  ...
  OR (
    {{ ui.ontable10.filters.ATD_Pickup_PortOfDischarge }} = 'empty'
...
AND (
  ...
  OR (
    {{ ui.ontable10.filters.ATA_Seaport }} = 'empty'
