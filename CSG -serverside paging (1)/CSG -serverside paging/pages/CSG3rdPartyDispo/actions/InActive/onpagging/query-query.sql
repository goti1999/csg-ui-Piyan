...
-- Sorting setup
DECLARE @SortColumn NVARCHAR(100) = '{{ ui.ontable11.sortColumn ?? "MBL_No" }}';
DECLARE @SortDirection NVARCHAR(4) = '{{ ui.ontable11.sortDirection ?? "ASC" }}';

-- Declare filter variables with proper null handling
DECLARE @CustomerID NVARCHAR(255) = '{{ ui.ontable11.filters.CustomerID ?? "" }}';
DECLARE @MBL_ID NVARCHAR(255) = '{{ ui.ontable11.filters.MBL_ID ?? "" }}';
DECLARE @ContainerID NVARCHAR(255) = '{{ ui.ontable11.filters.ContainerID ?? "" }}';
DECLARE @Status NVARCHAR(255) = '{{ ui.ontable11.filters.Status ?? "" }}';
DECLARE @TransmissionTimestamp NVARCHAR(255) = '{{ ui.ontable11.filters.TransmissionTimestamp ?? "" }}';
DECLARE @Voyage NVARCHAR(255) = '{{ ui.ontable11.filters.Voyage ?? "" }}';
DECLARE @ContainerSize NVARCHAR(255) = '{{ ui.ontable11.filters.ContainerSize ?? "" }}';
DECLARE @Broker NVARCHAR(255) = '{{ ui.ontable11.filters.Broker ?? "" }}';
DECLARE @Carrier NVARCHAR(255) = '{{ ui.ontable11.filters.Carrier ?? "" }}';
DECLARE @Vessel NVARCHAR(255) = '{{ ui.ontable11.filters.Vessel ?? "" }}';
DECLARE @PortOfDischarge_Lima NVARCHAR(255) = '{{ ui.ontable11.filters.PortOfDischarge_Lima ?? "" }}';
DECLARE @ETA_PortOfDischarge NVARCHAR(255) = '{{ ui.ontable11.filters.ETA_PortOfDischarge ?? "" }}';
DECLARE @PackingMethod NVARCHAR(255) = '{{ ui.ontable11.filters.PackingMethod ?? "" }}';
DECLARE @TotalWeight NVARCHAR(255) = '{{ ui.ontable11.filters.TotalWeight ?? "" }}';
DECLARE @AdvertFlag NVARCHAR(255) = '{{ ui.ontable11.filters.AdvertFlag ?? "" }}';
DECLARE @RealAdvertFlag NVARCHAR(255) = '{{ ui.ontable11.filters.RealAdvertFlag ?? "" }}';
DECLARE @EarliestAdvertDate NVARCHAR(255) = '{{ ui.ontable11.filters.EarliestAdvertDate ?? "" }}';
DECLARE @EarliestRealAdvertDate NVARCHAR(255) = '{{ ui.ontable11.filters.EarliestRealAdvertDate ?? "" }}';
DECLARE @todo NVARCHAR(255) = '{{ ui.ontable11.filters.todo ?? "" }}';
DECLARE @last_eventID NVARCHAR(255) = '{{ ui.ontable11.filters.last_eventID ?? "" }}';
DECLARE @PortOfLoading_Lima NVARCHAR(255) = '{{ ui.ontable11.filters.PortOfLoading_Lima ?? "" }}';
DECLARE @ETD_PortOfLoading NVARCHAR(255) = '{{ ui.ontable11.filters.ETD_PortOfLoading ?? "" }}';
DECLARE @Terminal_Inland_Vorgabe_NTL NVARCHAR(255) = '{{ ui.ontable11.filters.Terminal_Inland_Vorgabe_NTL ?? "" }}';
DECLARE @ETA_Terminal_Inland NVARCHAR(255) = '{{ ui.ontable11.filters.ETA_Terminal_Inland ?? "" }}';
DECLARE @DeliveryAddress NVARCHAR(255) = '{{ ui.ontable11.filters.DeliveryAddress ?? "" }}';
DECLARE @ETA_DeliveryAddress NVARCHAR(255) = '{{ ui.ontable11.filters.ETA_DeliveryAddress ?? "" }}';
DECLARE @Transport_Mode_Terminal NVARCHAR(255) = '{{ ui.ontable11.filters.Transport_Mode_Terminal ?? "" }}';
DECLARE @Transport_Mode_final_DeliveryAddress NVARCHAR(255) = '{{ ui.ontable11.filters.Transport_Mode_final_DeliveryAddress ?? "" }}';
DECLARE @ATA_DeliveryAddress NVARCHAR(255) = '{{ ui.ontable11.filters.ATA_DeliveryAddress ?? "" }}';
DECLARE @transport_Dispo_ID NVARCHAR(255) = '{{ ui.ontable11.filters.transport_Dispo_ID ?? "" }}';
DECLARE @Condition NVARCHAR(255) = '{{ ui.ontable11.filters.Condition ?? "" }}';
DECLARE @into_CW1 NVARCHAR(255) = '{{ ui.ontable11.filters.into_CW1 ?? "" }}';
DECLARE @to_Customer NVARCHAR(255) = '{{ ui.ontable11.filters.to_Customer ?? "" }}';
DECLARE @to_Transporter NVARCHAR(255) = '{{ ui.ontable11.filters.to_Transporter ?? "" }}';
DECLARE @DropOff_Terminal NVARCHAR(255) = '{{ ui.ontable11.filters.DropOff_Terminal ?? "" }}';
DECLARE @Terminal_PortOfDischarge NVARCHAR(255) = '{{ ui.ontable11.filters.Terminal_PortOfDischarge ?? "" }}';
DECLARE @Pincode NVARCHAR(255) = '{{ ui.ontable11.filters.Pincode ?? "" }}';
DECLARE @DropOff_Terminal_TIR NVARCHAR(255) = '{{ ui.ontable11.filters.DropOff_Terminal_TIR ?? "" }}';
DECLARE @Delivered NVARCHAR(255) = '{{ ui.ontable11.filters.Delivered ?? "" }}';
DECLARE @Remarks NVARCHAR(255) = '{{ ui.ontable11.filters.Remarks ?? "" }}';
DECLARE @HouseBill NVARCHAR(255) = '{{ ui.ontable11.filters.HouseBill ?? "" }}';
DECLARE @Containerverfuegbarkeit NVARCHAR(255) = '{{ ui.ontable11.filters.Containerverfuegbarkeit ?? "" }}';
DECLARE @ETA_Service_Provider NVARCHAR(255) = '{{ ui.ontable11.filters.ETA_Service_Provider ?? "" }}';
DECLARE @ATA_Terminal_Inland NVARCHAR(255) = '{{ ui.ontable11.filters.ATA_Terminal_Inland ?? "" }}';
DECLARE @ATD_Terminal_Inland NVARCHAR(255) = '{{ ui.ontable11.filters.ATD_Terminal_Inland ?? "" }}';
DECLARE @Return_Date_to_Depot NVARCHAR(255) = '{{ ui.ontable11.filters.Return_Date_to_Depot ?? "" }}';
DECLARE @ATD_Seaport NVARCHAR(255) = '{{ ui.ontable11.filters.ATD_Seaport ?? "" }}';
DECLARE @ETD_Seaport NVARCHAR(255) = '{{ ui.ontable11.filters.ETD_Seaport ?? "" }}';
DECLARE @ETA_Seaport NVARCHAR(255) = '{{ ui.ontable11.filters.ETA_Seaport ?? "" }}';
DECLARE @ATA_Seaport NVARCHAR(255) = '{{ ui.ontable11.filters.ATA_Seaport ?? "" }}';
DECLARE @final_date_delivery_address NVARCHAR(255) = '{{ ui.ontable11.filters.final_date_delivery_address ?? "" }}';
DECLARE @ctv_booking_id NVARCHAR(255) = '{{ ui.ontable11.filters.ctv_booking_id ?? "" }}';
DECLARE @CTV_ETA_PortOfDischarge NVARCHAR(255) = '{{ ui.ontable11.filters.CTV_ETA_PortOfDischarge ?? "" }}';
DECLARE @PortOfDischarge_UNLOCO NVARCHAR(255) = '{{ ui.ontable11.filters.PortOfDischarge_UNLOCO ?? "" }}';
DECLARE @PortOfLoading_UNLOCO NVARCHAR(255) = '{{ ui.ontable11.filters.PortOfLoading_UNLOCO ?? "" }}';
DECLARE @ATA_DropOff_Terminal NVARCHAR(255) = '{{ ui.ontable11.filters.ATA_DropOff_Terminal ?? "" }}';
DECLARE @DeliveryAddress_CTV NVARCHAR(255) = '{{ ui.ontable11.filters.DeliveryAddress_CTV ?? "" }}';
DECLARE @PortOfDischarge_UNLOCO_CTV NVARCHAR(255) = '{{ ui.ontable11.filters.PortOfDischarge_UNLOCO_CTV ?? "" }}';
DECLARE @Transport_Mode_Terminal_CTV NVARCHAR(255) = '{{ ui.ontable11.filters.Transport_Mode_Terminal_CTV ?? "" }}';
DECLARE @Carrier_CTV NVARCHAR(255) = '{{ ui.ontable11.filters.Carrier_CTV ?? "" }}';
DECLARE @customs_document_number NVARCHAR(255) = '{{ ui.ontable11.filters.customs_document_number ?? "" }}';
DECLARE @customs_document_type NVARCHAR(255) = '{{ ui.ontable11.filters.customs_document_type ?? "" }}';
DECLARE @Terminal_Inland_CTV NVARCHAR(255) = '{{ ui.transportDispoTable.filters.Terminal_Inland_CTV ?? "" }}';
DECLARE @ETD_Pickup_PortOfDischarge NVARCHAR(255) = '{{ ui.ontable11.filters.ETD_Pickup_PortOfDischarge ?? "" }}';
DECLARE @ATD_Pickup_PortOfDischarge NVARCHAR(255) = '{{ ui.ontable11.filters.ATD_Pickup_PortOfDischarge ?? "" }}';
DECLARE @pinRequested NVARCHAR(255) = '{{ ui.ontable11.filters.pinRequested ?? "" }}';
DECLARE @pinState NVARCHAR(255) = '{{ ui.ontable11.filters.pinState ?? "" }}';
DECLARE @nationalTransportState NVARCHAR(255) = '{{ ui.ontable11.filters.nationalTransportState ?? "" }}';
DECLARE @finalDeliveryState NVARCHAR(255) = '{{ ui.ontable11.filters.finalDeliveryState ?? "" }}';
DECLARE @emptyReturnState NVARCHAR(255) = '{{ ui.ontable11.filters.emptyReturnState ?? "" }}';
DECLARE @ETA_Terminal_Inland_Vorgabe_NTL NVARCHAR(255) = '{{ ui.ontable11.filters.ETA_Terminal_Inland_Vorgabe_NTL ?? "" }}';
DECLARE @DeliveryInfo_send_to_CTV NVARCHAR(255) = '{{ ui.ontable11.filters.DeliveryInfo_send_to_CTV ?? "" }}';
DECLARE @new NVARCHAR(255) = '{{ ui.ontable11.filters.new ?? "" }}';
DECLARE @Transport_Mode_Terminal_Vorgabe_NTL NVARCHAR(255) = '{{ ui.ontable11.filters.Transport_Mode_Terminal_Vorgabe_NTL ?? "" }}';
DECLARE @Terminal_Inland_CundA NVARCHAR(255) = '{{ ui.ontable11.filters.Terminal_Inland_CundA ?? "" }}';
DECLARE @Direct_Truck NVARCHAR(255) = '{{ ui.ontable11.filters.Direct_Truck ?? "" }}';
DECLARE @eventType NVARCHAR(255) = '{{ ui.ontable11.filters.eventType ?? "" }}';
DECLARE @Transport_To_Terminal NVARCHAR(255) = '{{ ui.ontable11.filters.Transport_To_Terminal ?? "" }}';
DECLARE @Transport_Document_Number NVARCHAR(255) = '{{ ui.ontable11.filters.Transport_Document_Number ?? "" }}';
DECLARE @Seal_Number NVARCHAR(255) = '{{ ui.ontable11.filters.Seal_Number ?? "" }}';
DECLARE @ETA_DeliveryAddress_CTV NVARCHAR(255) = '{{ ui.ontable11.filters.ETA_DeliveryAddress_CTV ?? "" }}';
DECLARE @Cancelation_Send_To_CTV NVARCHAR(255) = '{{ ui.ontable11.filters.Cancelation_Send_To_CTV ?? "" }}';
DECLARE @TAC NVARCHAR(255) = '{{ ui.ontable11.filters.TAC ?? "" }}';
DECLARE @ETA_Delivery_Address_Update_TimeStamp NVARCHAR(255) = '{{ ui.ontable11.filters.ETA_Delivery_Address_Update_TimeStamp ?? "" }}';
