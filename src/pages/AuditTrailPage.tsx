...
import { useApp, AuditEntry } from "@/contexts/AppContext";
...
export default function AuditTrailPage() {
  ...
  const [actionEntry, setActionEntry] = useState<AuditEntry | null>(null);
  ...
  const handleOpenView = (entry: AuditEntry) => {
    setSelectedEntry(entry);
    setIsViewDialogOpen(true);
  };

  const handleOpenAction = (entry: AuditEntry) => {
